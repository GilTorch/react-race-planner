...
const CharacterModal = ({ visible, onDismiss, parentType, parent, createReport, reportComment }) => {
          ...
          <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <View style={{ backgroundColor: 'white' }}>
              ...
              <View style={{ marginHorizontal: 20 }}>
                ...
                <TextInput
                  placeholder="Character full name goes here"
                  value={watch('name')}
                  multiline
...
export default connect(null, mapDispatchToProps)(CharacterModal);
