...
describe('Filter Page', () => {
  ...
  it('Should check that `Clear All` link2 is clickable and can clear all status', async () => {
    await filterPage.clearAllTwo.tap();
  });
