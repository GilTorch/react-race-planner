...
import { Round, UserRound, ProposedSection, MetaData } from '../../components/stories';
    ...
    <View
      ...
      <Surface
        ...
        <LinearGradient
          ...
          <MetaData label="Genre" value="Romance" />
      ...
      <ScrollView>
        <ProposedSection type="Intro" proposedBlocks={intros[2]} />
